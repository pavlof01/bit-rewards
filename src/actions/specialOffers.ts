...
export const SpecialOfferActions = {
  ...
  fetchOfferActionsListSuccess: (items: any) => createAction(FETCH_OFFER_ACTIONS_LIST_SUCCESS, items),
  ...
  fetchOfferRewardListSuccess: (items: any) => createAction(FETCH_OFFER_REWARD_LIST_SUCCESS, items),
